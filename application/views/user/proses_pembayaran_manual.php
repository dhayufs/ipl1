...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Public+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,100&display=swap" rel="stylesheet" />
...
<body>
    <?php
        ...
        $tagihan_ids = $this->input->post('tagihan_ids');
            ...
            <div class="authentication-inner">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Total Tagihan: <strong>Rp <?= number_format($total_bayar, 0, ',', '.'); ?></strong></p>
                        <hr>
                        ...
                        <?= form_open_multipart($proses_url, ['class' => 'mb-3']); ?>
                            <input type="hidden" name="total_bayar" value="<?= html_escape($total_bayar); ?>">
                            <?php if (!$is_logged_in): ?>
