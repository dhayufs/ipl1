            ...
            <div class="authentication-inner">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="pembayaran-form" method="POST" action="<?= base_url($is_logged_in ? 'user/bayarViaMidtrans' : 'auth/bayarViaMidtransPublic'); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#pembayaran-form').submit(function(e) {
                ...
                if (metode === 'manual') {
                    // Cukup ubah action form dan biarkan browser melakukan POST biasa
                    form.attr('action', '<?= base_url($manual_url); ?>');
                    return true; // Lanjutkan submit form
                } else if (metode === 'midtrans') {
                    e.preventDefault(); // Cegah submit form untuk AJAX
                    $.ajax({
                        type: 'POST',
