<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="<?= base_url('user'); ?>" class="app-brand-link">
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Aplikasi IPL</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="<?= base_url('user/laporPengontrak'); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-group"></i>
                <div data-i18n="Lapor Pengontrak">Lapor Pengontrak</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="<?= base_url('user/ubahProfil'); ?>" class="menu-link">
